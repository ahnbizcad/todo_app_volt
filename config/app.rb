...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todo-app-volt.com'
  config.app_name = 'Todo_app_volt'
  config.mailer.from = 'Todo_app_volt <no-reply@todo-app-volt.com>'
  ...
  #
  config.app_secret = 'wRV1WPwUGSp_n7xnS9mgb4yL92gxwLeue1mDR0Rw8YZ20j2JolZxrUKsdeCpPz6cLv4'
